...
public class PracticeActivityForExpt2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practice_for_expt2);
        num=getIntent().getStringExtra("Expt_number");
        Log.v("Num value in PA is ", num.toString());
        Button runYourExperiment2  = (Button) findViewById(R.id.submitInPracticeActivityForExpt2);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.hasChild("Device"))
                    ...
                    Toast.makeText(PracticeActivityForExpt2.this,"Please go to dashboard to register",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(PracticeActivityForExpt2.this,Student_dashboard.class));
                    finish();
                }
        ...
        q1_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(ch2_q1.isChecked()&&ch5_q1.isChecked()&&!ch1_q1.isChecked()&&!ch3_q1.isChecked()&&!ch4_q1.isChecked()) {
                    q1_f = 1;
                    Toast.makeText(PracticeActivityForExpt2.this,"Right Answer!",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    q1_f=0;
                    Toast.makeText(PracticeActivityForExpt2.this,"Wrong Answer",Toast.LENGTH_SHORT).show();
                }
        ...
        runYourExperiment2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...
//                });
                    ...
                    ref2.updateChildren(mp).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (!task.isSuccessful()) {
                                Toast.makeText(PracticeActivityForExpt2.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                ...
                {
                    Toast.makeText(PracticeActivityForExpt2.this,"One or more answer is incorrect! Can't Submit.",Toast.LENGTH_SHORT).show();
                }
